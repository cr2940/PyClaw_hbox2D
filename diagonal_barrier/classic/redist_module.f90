...
contains
        ...
        subroutine barrier_passing(hL,hR,huL,huR,bL,bR,wall_height,&
            ...
            if ( hL.gt.drytol ) then
              ...
              hstartest = max(hL,hm)
              ustartest = max(uL,um)
              ! print*, "rise1:",hL,hm,hstartest,bL
        ...
        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
          ...
          if ( L2R .and. R2L  ) then
            ...
            if ( aux_wall(2) .lt. aux_wall(3) ) then
              q_wall(1:3,2) = q_wall(1:3,3)
              aux_wall(2) = aux_wall(3)

            ! if wall is shorter " " " " left
          else if ( aux_wall(2) .le. aux_wall(1) ) then
